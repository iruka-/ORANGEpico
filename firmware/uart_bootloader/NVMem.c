...
#if	0
void _BOOTROM_ __attribute__((nomips16)) delay_us(UINT us)
{
...
* Note:		 	None.
********************************************************************/
UINT _BOOTROM_ NVMemOperation(UINT nvmop)
{
    int	int_status;
    int	susp;
 ...
 ********************************************************************/
UINT _BOOTROM_ NVMemErasePage(void* address)
{
    UINT res;
 ...
 ********************************************************************/
UINT _BOOTROM_ NVMemWriteWord(void* address, UINT data)
{
    UINT res;
 ...
 ********************************************************************/
UINT _BOOTROM_ NVMemWriteRow(void* address, void* data)
{
    unsigned int res;
 ...
 ********************************************************************/
UINT _BOOTROM_ NVMemClearError(void)
{
    unsigned int res;
