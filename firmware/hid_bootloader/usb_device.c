...
/** DEFINITIONS ****************************************************/
//DWORD ToPhysicalAddress(DWORD a);
//#define ConvertToPhysicalAddress(a) ToPhysicalAddress(a)
...
static void _BOOTROM_ USBConfigureEndpoint(BYTE EPNum, BYTE direction);
...
/**************************************************************************
  ...
  ***************************************************************************/
void _BOOTROM_ USBDeviceInit(void)
{
    BYTE i;
...
/*******************************************************************************
  ...
  Remarks:
    None                                                                                                          
  *****************************************************************************/
void _BOOTROM_ USBEnableEndpoint(BYTE ep, BYTE options)
{
    unsigned char* p;
...
/*************************************************************************
  ...
  *************************************************************************/
USB_HANDLE _BOOTROM_ USBTransferOnePacket(BYTE ep,BYTE dir,BYTE* data,BYTE len)
{
...
/*******************************************************************************
  ...
  Remarks:
    None                                                                                                          
  *****************************************************************************/
void _BOOTROM_ USBCtrlEPAllowStatusStage(void)
{
