...
#define	CONFIG_FPLLIDIV			IDIV_3	/* 12 MHz ->	4 MHz */	
#define	CONFIG_UPLLIDIV			IDIV_3	/* 12 MHz ->	4 MHz */	
#else

#ifdef	USE_16MHz_XTAL	// 16MHz
#define	CONFIG_FPLLIDIV			IDIV_4	/* 16 MHz ->	4 MHz */	
#define	CONFIG_UPLLIDIV			IDIV_4	/* 16 MHz ->	4 MHz */	
#else
